...
void stream(pixel_stream &src, /*pixel_stream &dst,*/ pixel_stream &dst_hq, rectangle rect_in_arg, uint8_t idx_arg, uint8_t write_rect_arg)
{
...
#pragma HLS INTERFACE s_axilite port=rect_in_arg
...
#pragma HLS PIPELINE II=1
	...
	static rectangle rect_in = {0,0,0,0,0};
